...
--------------------
22 R  STATUS        Бит 0..3: Счетчик нажатых клавиш
                    Бит 4: KBHIT, если =1, была нажата клавиша
                    Бит 5: SPI  Busy, если 1-устройство занято
                    Бит 6: DRAM Busy, если 1-устройсто занято
                    Бит 7: DRAM WE статус
22 W  COMMAND       Бит 7: =1 Запись в память SDRAM
                    Бит 4: =1 Сброс нажатой клавиши
--------------------
