...
// Список специальных функциональных клавиш
enum KEY_ASCII {
...
// 91 типов инструкции
static const struct maskopcode opcode_mask[91] = {
    ...
    {"000101rdddddrrrr", CP  },
    {"000110rdddddrrrr", SUB },
    {"000111rdddddrrrr", ADC },
    {"001000rdddddrrrr", AND },
    {"001001rdddddrrrr", EOR },
    {"001010rdddddrrrr", OR  },

    // Арифметика регистр + операнд K
    {"0011KKKKddddKKKK", CPI },
    {"0100KKKKddddKKKK", SBCI},
    {"0101KKKKddddKKKK", SUBI},
    {"0110KKKKddddKKKK", ORI },
    {"0111KKKKddddKKKK", ANDI},
    {"10010110KKddKKKK", ADIW},
    {"10010111KKddKKKK", SBIW},

    // Условные и безусловные переходы
    {"1100kkkkkkkkkkkk", RJMP },
    {"1101kkkkkkkkkkkk", RCALL},
    {"1001010100001000", RET  },
    {"1001010100011000", RETI },
    {"111100kkkkkkksss", BRBS },
    {"111101kkkkkkksss", BRBC },
    {"1111110ddddd0bbb", SBRC },
    {"1111111ddddd0bbb", SBRS },
    {"10011001AAAAAbbb", SBIC },
    {"10011011AAAAAbbb", SBIS },
    {"000100rdddddrrrr", CPSE },
    ...
    {"1001010kkkkk111k", CALL  },
    {"1001010kkkkk110k", JMP   },

    // Перемещения
    {"1110KKKKddddKKKK", LDI },
    {"001011rdddddrrrr", MOV },
    {"1001000ddddd0000", LDS },
    {"1001001ddddd0000", STS },
    {"00000001ddddrrrr", MOVW},
    {"1111100ddddd0bbb", BLD },
    {"1111101ddddd0bbb", BST },
    {"1001001ddddd0100", XCH },

    // Однооперандные
    {"1001010ddddd0011", INC },
    {"1001010ddddd1010", DEC },
    {"1001010ddddd0110", LSR },
    {"1001010ddddd0101", ASR },
    {"1001010ddddd0111", ROR },
    {"1001010ddddd0001", NEG },
    {"1001010ddddd0000", COM },
    {"1001010ddddd0010", SWAP},
    {"1001001ddddd0110", LAC },
    {"1001001ddddd0101", LAS },
    {"1001001ddddd0111", LAT },
    {"100101001sss1000", BCLR},
    {"100101000sss1000", BSET},
    {"10011000AAAAAbbb", CBI },
    {"10011010AAAAAbbb", SBI },

    // Косвенная загрузка из памяти
    {"1001000ddddd1100", LDX },
    {"1001000ddddd1101", LDX_},
    {"1001000ddddd1110", LD_X},
    {"1001000ddddd1001", LDY_},
    {"1001000ddddd1010", LD_Y},
    {"10q0qq0ddddd1qqq", LDYQ},
    {"1001000ddddd0001", LDZ_},
    {"1001000ddddd0010", LD_Z},
    {"10q0qq0ddddd0qqq", LDZQ},

    // Косвенное сохранение
    {"1001001ddddd1100", STX },
    {"1001001ddddd1101", STX_},
    {"1001001ddddd1110", ST_X},
    {"1001001ddddd1001", STY_},
    {"1001001ddddd1010", ST_Y},
    {"10q0qq1ddddd1qqq", STYQ},
    {"1001001ddddd0001", STZ_},
    {"1001001ddddd0010", ST_Z},
    {"10q0qq1ddddd0qqq", STZQ},

    // Загрузка из запись в память программ
    {"1001010111001000", LPM0Z },
    {"1001000ddddd0100", LPMRZ },
    {"1001000ddddd0101", LPMRZ_},
    {"1001010111101000", SPM   },
    {"1001010111111000", SPM2  },

    // Особые инструкции расширенной загрузки из памяти
    {"1001010111011000", ELPM0Z },
    {"1001000ddddd0110", ELPMRZ },
    {"1001000ddddd0111", ELPMRZ_},
    ...
    {"10110AAdddddAAAA", IN    },
    {"10111AAdddddAAAA", OUT   },
    {"1001001ddddd1111", PUSH  },
    {"1001000ddddd1111", POP   },
...
protected:
    ...
    // Таймеры и обработка событий в окне
    unsigned short timer;
    unsigned long  intr_timer, last_timer;
    int previous_timer, timer_loop;
